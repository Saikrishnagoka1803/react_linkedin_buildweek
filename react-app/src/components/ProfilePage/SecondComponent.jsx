...
const SecondComponent = () => {
    ...
    return(
       profilepost && profilepost.slice(length-5, length).reverse().map(ele => <Container className='mt-3' >
            
                <Row className='justify-content-center'>
                    <Col md={6} className='shadow' offset='2' style={{borderTop: '1px solid gray', borderRadius:'8px'}}>
                ...
                <Row className='justify-content-center'>
                    <Col md={6} className='text-left shadow' >
